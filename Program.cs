...
class Piano
{
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Используйте клавиши Q, W, E, R, T  для воспроизведения чёрных клавиш пианино.");
    ...
    static void PlayNote(ConsoleKey key)
    {
        ...
        switch (key)
        {
            ...
            case ConsoleKey.Q: noteIndex = 7; break;
            case ConsoleKey.W: noteIndex = 8; break;
            case ConsoleKey.E: noteIndex = 9; break;
            case ConsoleKey.R: noteIndex = 10; break;
            case ConsoleKey.T: noteIndex = 11; break;
        }
